...
const Section_2 = () => {
  return (
    <section className='py-10'>
        <div className='flex flex-row flex-nowrap justify-between xl:justify-around items-center '>
            <h1 className='font-bold text-[28px] leading-[33px] tracking-[20%]'>Featured Products</h1>
