...
const Section_2 = () => {
  return (
    <section className='flex flex-row flex-wrap justify-evenly items-center gap-10'>
        ...
        <div className='w-[337px] flex flex-row flex-nowrap gap-3'>
            ...
            <div>
                <h1 className='font-semibold text-[#242424] text-[20px] leading-[37px]'>High Quality</h1>
        ...
        <div className='w-[337px] flex flex-row flex-nowrap gap-3'>
            ...
            <div>
                <h1 className='font-semibold text-[#242424] text-[20px] leading-[37px]'>Warranty Protection</h1>
        ...
        <div className='w-[337px] flex flex-row flex-nowrap gap-3'>
            ...
            <div>
                <h1 className='font-semibold text-[#242424] text-[20px] leading-[37px]'>24 / 7 Support</h1>
