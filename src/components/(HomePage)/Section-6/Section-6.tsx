  ...
  return (
    <section className=''>
        ...
        <div className='flex flex-row flex-wrap gap-7 justify-center items-center w-[80vw] m-auto'>
            <Card image={"/images/section-3-home/1.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
            <Card image={"/images/section-3-home/2.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
            <Card image={"/images/section-3-home/3.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
            <Card image={"/images/section-3-home/4.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
            <Card image={"/images/section-3-home/3.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
            <Card image={"/images/section-3-home/2.svg"} name='Product name' price="$18" link={1} allowResponsiveness={true}/>
