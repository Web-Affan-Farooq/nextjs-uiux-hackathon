...
/**
                     <h1 className='leading-[12.8px] text-[16px] font-semibold group-hover:text-blue transition-all'>Card titlefgjkdgf gfdjgiodf igodf giodf giodfugiodf gioufdiog </h1>
 */
/*
